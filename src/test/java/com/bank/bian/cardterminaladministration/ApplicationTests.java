...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Card Terminal Administration");
        assertThat(meta).containsEntry("functionalPattern", "Administer");
    }

    @Test
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/card-terminal-administrative-plan/initiate",

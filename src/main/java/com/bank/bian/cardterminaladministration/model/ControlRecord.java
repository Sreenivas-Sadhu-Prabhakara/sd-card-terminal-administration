package com.bank.bian.cardterminaladministration.model;
...
/**
 * The BIAN control record for this service domain: "Card Terminal Administrative Plan".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Administer) applied
 * to its asset type (Card Terminal). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Card Terminal Administrative Plan";
